...
<body>
    ...
    <div class="menuButton">
        <button id="updateCustomer" onclick="updateRow(this)">목록 수정</button>
        <button id="deleteCustomer" onclick="deleteRow(this)" style=" margin-left: 10px; background-color:#F15F5F" >거래처 삭제</button>
    </div>
...
<script>
        ...
        document.addEventListener('DOMContentLoaded', () => {  // DOMContentLoaded : 스크립트가 시작할 준비가 됐으면 function 함수실행
            new agGrid.Grid(myGrid, estGridOptions);        // accoutGrid는 div태그의 변수이름이고 , estGridOptions는 안에 들어갈 값들이다
        ...
        let estGridOptions = {
            ...
            localeText: {noRowsToShow: '새로고침하면 보입니다.'}, // "key": "dateue"
